...
<body>
  <div class="container">
    ...
    <form action="http://localhost/sistema-biblioteca2/usuario/post" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="password" id="xenha" name="senha" placeholder="senha" required>
      </div>

      <button type="submit" class="btn btn-success">CADASTRAR</button>
      <a href="http://localhost/sistema-biblioteca2/cadastro" class="btn btn-primary">VOLTAR</a>
    </form>
  </div>
